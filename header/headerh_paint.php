...
<header>
    ...
    <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="10">
                <img src="../img/header/header_hpaint.png" class="d-block w-100">
            </div>
        </div>
    </div>
    ...
    <div class="row">
            <div class="col-md-3" id="menu_nail">
                <ul>
                    <h4>ประเภทลายเล็บ</h4>
                    <li><a href="headerh_p.php">
                            <img src="../img/icon/nail_p.png"  width="30" height="30">  ลายสีพื้น
                        </a>
                    </li>
                    <li><a class="active" href="headerh_paint.php">
                            <img src="../img/icon/nail_paint.png"  width="30" height="30">  ลายเพ้นท์
                        </a>
                    </li>
                    <li><a href="headerh_gt.php">
                            <img src="../img/icon/nail_gt.png"  width="30" height="30">  ลายกลิตเตอร์
                        </a>
                    </li>
                    <li><a href="headerh_stg.php">
                            <img src="../img/icon/nail_stg.png"  width="30" height="30">  ลายสติ๊กเกอร์
                        </a>
                    </li>
                    <li><a href="headerh_lk.php">
                            <img src="../img/icon/nail_lk.png"  width="30" height="30">  ลายลูกแก้ว
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-lg-8 col-xl-8 col-md-12 col-sm-12 col-12">
                <div class="row" style="margin-top: 40px;">
                    <?php
                        ...
                        WHERE service_item.S_ID = 2 and service_item.nt_id = 1 and service_item.ns_id = 1");
                    ...
                    <div class="col-lg-3 col-xl-3 col-md-12 col-sm-12 col-12">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                            <span style="margin-top: -0.5em;"> <?php echo $row['name']; ?></span><br>
                            <span style="margin-top: -0.5em;"> <?php echo $row['detail']; ?></span><br>
                            <span style="margin-top: -0.5em;"> <?php echo $row['price']; ?></span><br>
                                <div class="row">
                                    <div class="col">
