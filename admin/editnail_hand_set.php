            ...
            <div class="row" >
                ...
                <div class="col-10" id="btn_editnail">
                    <ul>
                        ...
                        <li><a class="active" href="editnail_hand_set.php">
                        ...
                        <table class="table table-striped table-hover" width="100%">
                            ...
                            <tbody id="result">
                                <?php
                                    ...
                                    WHERE service_item.S_ID = 1 and service_item.nt_id = 1 and service_item.ns_id = 2");
                        ...
                        <table class="table table-striped table-hover" width="100%">
                            ...
                            <tbody id="result">
                                <?php
                                    ...
                                    INNER join nail_type on nail_type.nt_id=service_item.nt_id
                                    INNER join nail_set on nail_set.ns_id=service_item.ns_id
                                    WHERE service_item.S_ID = 2 and service_item.nt_id = 1 and service_item.ns_id = 2");
                                    while($row=mysqli_fetch_array($query)){
                                    ?>
                                <tr>
                                    <td scope="row" data-label="ลำดับ"><?php echo $n ?></td>
                        ...
                        <table class="table table-striped table-hover" width="100%">
                            ...
                            <tbody id="result">
                                <?php
                                    ...
                                    INNER join nail_type on nail_type.nt_id=service_item.nt_id
                                    INNER join nail_set on nail_set.ns_id=service_item.ns_id
                                    WHERE service_item.S_ID = 4 and service_item.nt_id = 1 and service_item.ns_id = 2");
                                    while($row=mysqli_fetch_array($query)){
                                    ?>
                                <tr>
                                    <td scope="row" data-label="ลำดับ"><?php echo $n ?></td>
                        ...
                        <table class="table table-striped table-hover" width="100%">
                            ...
                            <tbody id="result">
                                <?php
                                    ...
                                    INNER join nail_type on nail_type.nt_id=service_item.nt_id
                                    INNER join nail_set on nail_set.ns_id=service_item.ns_id
                                    WHERE service_item.S_ID = 5 and service_item.nt_id = 1 and service_item.ns_id = 2");
                                    while($row=mysqli_fetch_array($query)){
                                    ?>
                                <tr>
                                    <td scope="row" data-label="ลำดับ"><?php echo $n ?></td>
