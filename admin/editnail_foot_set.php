    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-10" id="btn_editnail">
                <ul>
                    ...
                    <li><a href="editnail_foot_one.php">
                            <img src="../img/icon/nail_gt.png" width="30" height="30">ลายเล็บเท้าแบบ 1 นิ้ว
                        </a>
                    </li>
                    <li><a class="active" href="editnail_foot_set.php">
        ...
        <div class="row">
            ...
            <div class="col-md-10" id="add_datanail">
                <img src="../img/icon/setp.png" width="20" height="20">&nbsp;&nbsp; ลายเล็บสีพื้น
                                ...
                                <thead>
                                    ...
                                    <?php
                                        ...
                                        $query = mysqli_query($conn, "SELECT * FROM service_item 
                                            ...
                                            WHERE service_item.S_ID = 1 and service_item.nt_id = 2 and service_item.ns_id = 2");
                                    ...
                                    <tbody id="result">
                                            <tr>
                                                ...
                                                <td data-label="">
                                                    <span>
                                                        <a href="#edit<?php echo $row['ST_ID']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></span> แก้ไข</a>
        ...
        <div class="row">
            <div class="col-md-1"></div>
            <div class="col-md-10" id="add_datanail">
                <img src="../img/icon/setpaint.png" width="20" height="20">&nbsp;&nbsp; ลายเล็บสีเพ้นท์
                <a href="#add_data" class="btn" data-toggle="modal"><i class="bi bi-plus-circle"></i> เพิ่มข้อมูลลายเล็บ</a>
                <hr>
            </div>
            <div class="col-md-1"></div>
                        ...
                        <div class="table-wrapper-scroll-y my-custom-scrollbar">
                            <table class="table table-striped table-hover" width="100%">
                                ...
                                <tbody id="result">
                                    ...
                                    INNER join nail_type on nail_type.nt_id=service_item.nt_id
                                    INNER join nail_set on nail_set.ns_id=service_item.ns_id
                                    WHERE service_item.S_ID = 2 and service_item.nt_id = 2 and service_item.ns_id = 2");
                                    while ($row = mysqli_fetch_array($query)) {
                                    ?>
                                        <tr>
                                            <td scope="row" data-label="ลำดับ"><?php echo $n ?></td>
        ...
        <div class="row">
            <div class="col-md-1"></div>
            <div class="col-md-10" id="add_datanail">
                <img src="../img/icon/setgt.png" width="20" height="20">&nbsp;&nbsp; ลายเล็บกลิตเตอร์
                <a href="#add_data" class="btn" data-toggle="modal"><i class="bi bi-plus-circle"></i> เพิ่มข้อมูลลายเล็บ</a>
                <hr>
            </div>
            <div class="col-md-1"></div>
                        ...
                        <div class="table-wrapper-scroll-y my-custom-scrollbar">
                            <table class="table table-striped table-hover" width="100%">
                                ...
                                <tbody id="result">
                                    ...
                                    INNER join nail_type on nail_type.nt_id=service_item.nt_id
                                    INNER join nail_set on nail_set.ns_id=service_item.ns_id
                                    WHERE service_item.S_ID = 3 and service_item.nt_id = 2 and service_item.ns_id = 2");
                                    while ($row = mysqli_fetch_array($query)) {
                                    ?>
                                        <tr>
                                            <td scope="row" data-label="ลำดับ"><?php echo $n ?></td>
        ...
        <div class="row">
            <div class="col-md-1"></div>
            <div class="col-md-10" id="add_datanail">
                <img src="../img/icon/setstg.png" width="20" height="20">&nbsp;&nbsp; ลายเล็บสติ๊กเกอร์
                <a href="#add_data" class="btn" data-toggle="modal"><i class="bi bi-plus-circle"></i> เพิ่มข้อมูลลายเล็บ</a>
                <hr>
            </div>
            <div class="col-md-1"></div>
                        ...
                        <div class="table-wrapper-scroll-y my-custom-scrollbar">
                            <table class="table table-striped table-hover" width="100%">
                                ...
                                <tbody id="result">
                                    ...
                                    INNER join nail_type on nail_type.nt_id=service_item.nt_id
                                    INNER join nail_set on nail_set.ns_id=service_item.ns_id
                                    WHERE service_item.S_ID = 4 and service_item.nt_id = 2 and service_item.ns_id = 2");
                                    while ($row = mysqli_fetch_array($query)) {
                                    ?>
                                        <tr>
                                            <td scope="row" data-label="ลำดับ"><?php echo $n ?></td>
        ...
        <div class="row">
            <div class="col-md-1"></div>
            <div class="col-md-10" id="add_datanail">
                <img src="../img/icon/setlk.png" width="20" height="20">&nbsp;&nbsp; ลายเล็บลูกแก้ว
                <a href="#add_data" class="btn" data-toggle="modal"><i class="bi bi-plus-circle"></i> เพิ่มข้อมูลลายเล็บ</a>
                <hr>
            </div>
            <div class="col-md-1"></div>
                            ...
                            <table class="table table-striped table-hover" width="100%">
                                ...
                                <tbody id="result">
                                    ...
                                    $query = mysqli_query($conn, "SELECT * FROM service_item 
                                        ...
                                        INNER join nail_type on nail_type.nt_id=service_item.nt_id
                                        INNER join nail_set on nail_set.ns_id=service_item.ns_id
                                        WHERE service_item.S_ID = 5 and service_item.nt_id = 2 and service_item.ns_id = 2");
                                    while ($row = mysqli_fetch_array($query)) {
                                    ?>
                                        <tr>
                                            <td scope="row" data-label="ลำดับ"><?php echo $n ?></td>
